...
from keras.layers import Input, Dense, Embedding, CuDNNLSTM, GlobalMaxPooling1D
...
def LSTM_network(MAX_LEN, EMBEDDING_DIM, word_index, embedding_matrix, use_dropout=True):
    ...
    lstm_1 = CuDNNLSTM(128, return_sequences=True)(sharable_embedding)  # The default activation is 'tanh',
    if use_dropout:
        droput_layer_1 = Dropout(0.5)(lstm_1)
        lstm_2 = CuDNNLSTM(64, return_sequences=True)(droput_layer_1)
    else:
